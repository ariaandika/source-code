...
public class Q : MonoBehaviour
{
	...
	// Sin Cos Tan
	public Vector2 AngByVec(float angle)
	{
		return new Vector2(Mathf.Cos(angle), Mathf.Sin(angle));
	}
	public Vector2 Veconv(Vector3 x)
	{
		return new Vector2(x.x, x.y);
	}

	// Other -------------------------------------------------------------------------------------------------------------------------------------------------
	public bool OtApprox(float a, float b, float threshold = 0.01f)
	{
		return Mathf.Abs(a - b) <= threshold;
	}
	public bool OtApprox(Vector3 a, Vector3 b, float threshold = 0.01f)
	{
